...
export function endpoint_to_center2(x1:number, y1:number, x2:number, y2:number,
    fA:number|boolean, fS:number|boolean, outPr:number[], phi:number, outCenter:number[], outTheta:number[]) {
    const M_PI = Math.PI
