...
const _matrix=Matrix4.default()
const _quaternion=Quaternion.default()
export class Euler {
    ...
    clone() {
        ...
        return new (this.constructor as typeof Euler)(this._x, this._y, this._z, this._order);
    ...
    setFromRotationMatrix(m:Matrix4, order:string = this._order, update = true) {
