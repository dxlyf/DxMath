...
import {Raster3D,Object3D,Mesh,Geometry,Camera,createCubeVertices,Texture,Vertex,Face3} from 'src/computer_graphic/3d'

import imageUrl from '../assets/uv_grid_opengl.jpg'
