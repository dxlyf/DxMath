    ...
    Add3(b: Point26_6, c: Point26_6, d: Point26_6) {
        ...
        while (i >= 0) {
            ...
            if (s > 0) {
                ...
                p[6] = Point26_6.from(p[3].x, p[3].y);
                p[5] = Point26_6.from(m23x, (p[2].y + p[3].y) / 2);
                p[1] = Point26_6.from(m01x, (p[0].y + p[1].y) / 2);
                p[2] = Point26_6.from((m01x + m12x) / 2, (p[1].y + p[2].y) / 2);
                p[4] = Point26_6.from((m12x + m23x) / 2, (p[2].y + p[3].y) / 2);
                p[3] = Point26_6.from((p[2].x + p[4].x) / 2, (p[2].y + p[4].y) / 2);
